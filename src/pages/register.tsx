    ...
    <Layout>
      <div className="flex justify-center items-center min-h-screen bg-gray-100 px-4 sm:px-6 md:px-8">
        <div className="w-full max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl bg-white p-6 sm:p-8 rounded-md shadow-md">
          ...
          <p className="text-gray-700 text-sm sm:text-base md:text-lg mb-4 sm:mb-6 text-center">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-3 sm:mb-4 md:mb-5">
              <label htmlFor="username" className="block text-sm sm:text-base font-medium text-gray-700 mb-1">
                Username:
              </label>
              <input
                type="text"
                id="username"
                name="username"
                className="w-full p-2 sm:p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-500 text-black font-medium text-sm sm:text-base md:text-lg"
            ...
            <div className="mb-3 sm:mb-4 md:mb-5">
              ...
              <input
                ...
                required
              />
              <ul className="text-xs sm:text-sm md:text-base text-gray-600 mt-2">
            ...
            <div className="mb-4 sm:mb-6 md:mb-7">
              <label htmlFor="confirm-password" className="block text-sm sm:text-base font-medium text-gray-700 mb-1">
                Confirm Password:
              </label>
              <input
                type="password"
            ...
            <button
              type="submit"
              className="w-full bg-yellow-500 text-white py-2 sm:py-3 md:py-4 rounded-md hover:bg-yellow-600 transition duration-200 text-sm sm:text-base md:text-lg"
            >
              Sign Up
            </button>
          </form>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 px-4">
          <div className="bg-white rounded-lg shadow-lg p-5 sm:p-6 md:p-8 w-full max-w-xs sm:max-w-sm md:max-w-md">
            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-yellow-500 mb-3 sm:mb-4 text-center">
              Account Created!
            </h2>
            <p className="text-gray-700 text-sm sm:text-base md:text-lg text-center mb-4 sm:mb-6">
            ...
            <div className="flex justify-center">
              <Link
                href="/login"
                className="bg-black text-yellow-500 py-2 sm:py-3 px-4 sm:px-6 rounded-md hover:bg-gray-800 transition duration-200 text-sm sm:text-base md:text-lg"
              >
                Go to Login
              </Link>
            </div>
