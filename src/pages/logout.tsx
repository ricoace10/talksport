  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col bg-gray-100">
        {/* Navbar */}
        <header className="bg-black text-yellow-400 flex justify-between items-center px-4 sm:px-6 py-4">
        ...
        <main className="flex-grow px-4 py-6 flex flex-col items-center justify-center">
          <h2 className="text-3xl sm:text-4xl text-yellow-800 font-extrabold mb-4 sm:mb-6">
            TalkSport
          </h2>
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md text-center w-full max-w-xs sm:max-w-sm">
            <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-3 sm:mb-4">Sign Out</h3>
            ...
            <button
              ...
              className="bg-black text-yellow-400 py-2 sm:py-3 px-4 sm:px-6 rounded-md hover:bg-gray-800 transition duration-200 text-sm sm:text-base font-semibold"
            >
              Sign Out
            </button>
          </div>
        ...
        {/* Footer */}
        <footer className="bg-black text-yellow-400 text-center py-3 sm:py-4 text-sm sm:text-base">
          TalkSport © 2024
        </footer>
      </div>
    </>
